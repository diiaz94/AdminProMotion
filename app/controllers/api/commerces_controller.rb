class Api::CommercesController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @commerce.save
        format.html { redirect_to admin_commerces_path, notice: 'Categoria creada exitosamente.' }
  ...
  def update
    respond_to do |format|
      ...
      if @commerce.update(commerce_params)
        format.html { redirect_to admin_commerces_path, notice: 'Categoria actualizada exitosamente.' }
