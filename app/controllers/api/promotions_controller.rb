class Api::PromotionsController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @promotion.save
        format.html { redirect_to admin_promotions_path, notice: 'Categoria creada exitosamente.' }
  ...
  def update
    respond_to do |format|
      ...
      if @promotion.update(promotion_params)
        format.html { redirect_to admin_promotions_path, notice: 'Categoria actualizada exitosamente.' }
