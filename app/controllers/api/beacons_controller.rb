class Api::BeaconsController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @beacon.save
        format.html { redirect_to admin_beacons_path, notice: 'Categoria creada exitosamente.' }
  ...
  def update
    respond_to do |format|
      ...
      if @beacon.update(beacon_params)
        format.html { redirect_to admin_beacons_path, notice: 'Categoria actualizada exitosamente.' }
