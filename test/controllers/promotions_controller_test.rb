...
class PromotionsControllerTest < ActionController::TestCase
  ...
  test "should create promotion" do
    assert_difference('Promotion.count') do
      post :create, promotion: { active: @promotion.active, description: @promotion.description, picture: @promotion.picture, price: @promotion.price, title: @promotion.title, until: @promotion.until }
    end
  ...
  test "should update promotion" do
    patch :update, id: @promotion, promotion: { active: @promotion.active, description: @promotion.description, picture: @promotion.picture, price: @promotion.price, title: @promotion.title, until: @promotion.until }
    assert_redirected_to promotion_path(assigns(:promotion))
  end
